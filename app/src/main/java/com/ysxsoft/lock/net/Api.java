...
public interface Api {
    ...
    public final String PROVINCE_LIST="/api/pcd/listp";//省列表
    public final String CITY_LIST="/api/pcd/listc";//市列表
    public final String DISTRICT_LIST="/api/pcd/lista";//区县列表
    public final String VERFY_CODE="/api/sms/verifycode";//校验验证码
    public final String GET_PHONE="/api/sms/sendsms";//获取手机验证码
