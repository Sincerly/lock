 ...
 * on 2019/12/30 0030
 */
@Route(path = "/main/ThrowInVipRecordActivity")
public class ThrowInVipRecordActivity extends BaseActivity implements IListAdapter<ThrowInListResponse.DataBean> {
    ...
    public static void start(){
        ARouter.getInstance().build(ARouterPath.getThrowInVipRecordActivity()).navigation();
    }
...
//        helper.setText(R.id.tvNikeName, "会员昵称：");
        TextView tvCheck = helper.getView(R.id.tvCheck);
        if (helper.getAdapterPosition() % 2 == 0) {
            helper.setText(R.id.tvTime, "投放日期：");
            tvCheck.setText("已核销");
            tvCheck.setTextColor(mContext.getResources().getColor(R.color.color_666666));
        } else {
            helper.setText(R.id.tvTime, "核销日期：");
            tvCheck.setText("未核销");
            tvCheck.setTextColor(mContext.getResources().getColor(R.color.color_3BB0D2));
        }
