                                    ...
                                    protected void fillItem(RViewHolder holder, CardListResponse.DataBean item, int position) {
                                        ...
                                        edit.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                AddPacketMoneyActivity.start(1,canEdit,item.getId(),item.getPrice(),item.getOprice(), AppConfig .BASE_URL+item.getImg(),item.getTitle(),item.getPrice());
                                            }
                                        });
...
//                AddPacketMoneyActivity.start(1);
                getStatus();
                break;
        }
    }
