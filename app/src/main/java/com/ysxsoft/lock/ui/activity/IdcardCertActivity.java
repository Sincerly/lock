...
import com.ysxsoft.lock.ui.fragment.TabIdcardCert1Fragment;
import com.ysxsoft.lock.ui.fragment.TabIdcardCert2Fragment;
...
**/
@Route(path = "/main/IdcardCertActivity")
public class IdcardCertActivity extends BaseActivity {
    ...
    public static void start(){
        ARouter.getInstance().build(ARouterPath.getIdcardCertActivity()).navigation();
    }
    ...
    public void doWork() {
        ...
        titles.add("中国籍");
        titles.add("外国籍");
        fragmentList.add(new TabIdcardCert1Fragment());
        fragmentList.add(new TabIdcardCert2Fragment());
